...
public class SteelFluidTankItem extends BlockItem {

    public SteelFluidTankItem(Block p_i48527_1_, Properties p_i48527_2_) {
    ...
    protected boolean updateCustomBlockEntityTag(BlockPos p_195943_1_, Level p_195943_2_, Player p_195943_3_,
        ...
        if (nbt != null) {
            ...
            if (nbt.contains("TankContent")) {
                ...
                if (!fluid.isEmpty()) {
                    fluid.setAmount(Math.min(SteelFluidTankBlockEntity.getCapacityMultiplier(), fluid.getAmount()));
    ...
    private void tryMultiPlace(BlockPlaceContext ctx) {
        ...
        if (!SteelFluidTankBlock.isTank(placedOnState)) // maybe an issue
            return;
